...
<h:inputText id="user-name" value="#{YubikeyLoginBean.username}" validator="#{YubikeyLoginBean.validateUsername}" onkeyup="updateButtonState();" onchange="updateButtonState();" style="width:150px" />
</td>
</tr>
...
<h:inputSecret id="user-password" value="#{YubikeyLoginBean.password}" validator="#{YubikeyLoginBean.validatePassword}" style="width:150px" />
</td>
</tr>

<tr>
<td>
<h:outputText value="#{customMsg.key}"/>:
</td>
<td>
<h:inputText id="user-otp" value="#{YubikeyLoginBean.otp}" onchange="updateButtonState();" style="width:150px" />
</td>
</tr>

<tr>
<td>
<h:outputText value="#{msg.language}:" rendered="#{YubikeyLoginBean.languageSelect}" />
</td>
<td>
<%-- language selection drop-down --%>
<h:selectOneMenu id="language" value="#{UserPreferencesBean.language}" style="width:150px" onchange="document.forms['loginForm'].submit(); return true;" rendered="#{YubikeyLoginBean.languageSelect}">
...
<h:commandButton id="submit" action="#{YubikeyLoginBean.login}" value="#{msg.login}" />
</td>
</tr>
...
function validateOTP(elem)
{
var len = elem.value.length;
return elem.value.match(/^[cbdefghijklnrtuv]+$/) && (32 <= len && len <= 48);
}

function validate()
{
return validateUserNameForLogin(document.getElementById("loginForm:user-name"), null, false) && validateOTP(document.getElementById("loginForm:user-otp"));
}
